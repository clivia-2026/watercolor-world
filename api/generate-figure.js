...
const STYLE_BIBLE = [
  ...
  '统一为温柔、安静、治愈的日系手绘动画角色感，不是Q版，不是廉价卡通，不是扁平矢量。',
  '统一为接近真人的自然比例，但轮廓略微简化，角色感明确，人物和动物都像来自同一个温暖动画世界。',
  '统一使用干净轻柔的线条、柔和低饱和配色、简洁平滑的手绘上色感、克制阴影、极简纯白背景。',
  '统一保持中高级审美，轻盈、柔和、自然、亲切，不允许漂成厚涂、照片精修、强写实、儿童插画、夸张二次元或廉价漫画风。',
  '所有图片都要像出自同一个系列、同一套世界观、同一批角色设定图。',
].join(' ');
...
function buildHumanEditPrompt() {
  return [
    ...
    '保留原照片中的发色、发型趋势、刘海感觉、眼镜、帽子、脸部朝向、穿搭轮廓、上衣颜色、下装颜色、包或配饰。',
    ...
    '人物必须完整站立在画面中，脚必须出现，不能裁掉腿脚，不能只生成头像或半身。',
    '如果衣服是黑色、深灰、藏蓝等深色，必须保持深色，不要洗成白色、米色或浅灰。',
    '如果额前发型不明显，请自然补成好看的八字刘海或轻碎发，但不要夸张。',
    '整体画风：温柔、安静、治愈的日系手绘动画角色感，脸部简化但要像本人，线条干净轻柔，颜色低饱和，质感统一，背景纯白。',
...
function buildAnimalEditPrompt() {
  return [
    ...
    '整体原则是贴近原照片，只做温和的动画角色化处理，不要大改物种特征和颜色。',
    ...
    '整体画风：温柔、安静、治愈的日系手绘动画动物角色感，线条轻柔，形体简洁，毛感柔软，颜色低饱和，背景纯白，风格要固定统一。',
